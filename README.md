...
- Web client — how to run it, and what it does that the phone can't: [web/README.md](web/README.md)
- Web client implementation plan (Phases 0–6, all shipped): [docs/WEB_PLAN.md](docs/WEB_PLAN.md)
