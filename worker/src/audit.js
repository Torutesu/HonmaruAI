...
export const AUDIT_ACTIONS = {
  ...
  "retention.pruned": { category: "workspace", severity: "notice", text: "Messages and files past their retention were deleted" },
  "hold.placed": { category: "audit", severity: "critical", text: "{actor} placed a legal hold on {entity}" },
  "hold.released": { category: "audit", severity: "critical", text: "{actor} released a legal hold" },
  "compliance.exported": { category: "audit", severity: "critical", text: "{actor} made a compliance export" },
  "compliance.downloaded": { category: "audit", severity: "critical", text: "{actor} downloaded a compliance export" },
  "security.ip_blocked": { category: "security", severity: "warning", text: "Use from an address outside the allowed networks was refused" },
  "member.invite_held": { category: "membership", severity: "notice", text: "{actor} used an invitation that needs an admin's approval" },
