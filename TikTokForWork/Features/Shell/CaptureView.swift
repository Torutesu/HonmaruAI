        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    Text("Speech is transcribed on this device only. When you generate an AI draft, the text is sent to OpenAI, not your microphone audio. If on-device recognition is unavailable, type your request instead.")
