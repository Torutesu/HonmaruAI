...
final class WorkspaceMemberServiceTests: XCTestCase {
    ...
    func testRetriesATransientServerFailureAndReturnsMembers() async throws {
        ...
        MemberProtocol.enqueue(
            status: 200,
            body: Data(#"{"editable":true,"members":[{"ref":"opaque-ref","name":"Mika","role":"member","title":"Design","mine":false}]}"#.utf8)
        )
        ...
        XCTAssertEqual(members.map(\.id), ["member:opaque-ref"])
        XCTAssertEqual(members.first?.role, "Design")
